<?php
    ...
    if(isset($_POST['save']))
    {
        ...
        else
        {
            ...
            $query = " insert into appointment (Owner_Name, Appoinment_Date, Appointment_Time, Email_address, Provincial_Add, Contact_num, Pet_Name, Reason_of_Appointment, Status_sched, Other_Reasons) values('$Owner_Name','$Appoinment_Date','$Appointment_Time', '$Email_address', '$Provincial_Add', '$Contact_num', '$Pet_Name', '$Reason_of_Appointment', '$Status_sched', '$Other_Reasons')";
