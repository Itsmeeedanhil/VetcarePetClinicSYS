			          ...
			          <div class="col-auto my-auto">
			            <div class="h-100" id="form">
								  ...
								  <div class="row mb-4">
								    <div class="col">
								      <div class="form-outline">
								        <input readonly type="text" id="accin" name="p_name" class="form-control" value="<?php echo $p_name?>"  />
								        <label class="form-label" for="form6Example1">Pet name</label>
								      </div>
								    </div>
								    <div class="col">
								      <div class="form-outline">
								        <input readonly type="text" id="accin" name="l_name" class="form-control" value="<?php echo $l_name?>" />
								  ...
								  <div class="form-outline mb-4">
								    <textarea readonly class="form-control" name="examination" id="accin" rows="3"><?php echo $examination?></textarea>
								    <label class="form-label" for="form6Example3">Examination</label>
								  </div>

								  <!-- Text input -->
								  <div class="form-outline mb-4">
								    <textarea readonly class="form-control"  name="test" id="accin" rows="3"><?php echo $test?></textarea>
								    <label class="form-label" for="form6Example4">Test</label>
								  </div>

								  <!-- Email input -->
								  <div class="form-outline mb-4">
								    <textarea readonly class="form-control" name="d_diagnosis" id="accin" rows="3"><?php echo $d_diagnosis?></textarea>
								    <label class="form-label" for="form6Example5">Differential Diagnosis</label>
								  </div>

								  <!-- Number input -->
								  <div class="form-outline mb-4">
								    <textarea readonly class="form-control" name="c_diagnosis" id="accin" rows="3"><?php echo $c_diagnosis?></textarea>
								    <label class="form-label" for="form6Example6">Consult Diagnosis</label>
								  </div>

								  <!-- Message input -->
								  <div class="form-outline mb-4">
								    <textarea readonly class="form-control"  name="treatment" id="accin" rows="4"><?php echo $treatment?></textarea>
								    <label class="form-label" for="form6Example7">Treatment</label>
								  </div>


								  <a href="Docpetinfo.php" class="btn btn-primary btn-block mb-4" id="btn1" onclick="return confirm('Do you want to return Pet Information?')">Return</a>
								  <!-- Submit button -->
