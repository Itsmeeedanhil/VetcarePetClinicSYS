...
<div class="container rounded bg-white mt-5 mb-5" style="margin-left: 395px; width: 900px;">
    <div class="row">
      <div class="col-md">
        <div class="Patientviewinfo">
          <div class="legend"></div>
                  ...
                  <input readonly type="Text" id="stat1" name="Status_sched" value="<?php echo $status_sched ?>"><br>
                    ...
                    <a href="appointment.php" id="btnreturn" class="btn btn-secondary">Return</a>
        </div>
