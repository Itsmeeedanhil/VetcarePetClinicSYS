...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
  <div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
      ...
      <h6 class="font-weight-bolder mb-0">Receptionist Appointment</h6>
                ...
                <div class="col-auto my-auto">
                  <div class="h-100">
                        <h6 class="font-weight-bolder mb-0 text-center">Appointment Records</h6>
                            ...
                            <a class="btn btn-xs btn-warning" href="index.php" style="margin-left: 812px; margin-top: 20px;font-size: 11px; margin-bottom: -10px;">Manage Notifications</a>
                                      </td>
                          ...
                          <div class="row" style="margin-top: 20px;">
                                  ...
                                  <tr class="table table-dark table-striped table-sm table-bordered" style="color: black;">
                                      ...
                                      <td><a class="btn btn-xs btn-info" href="Receptionistviewpage.php?GetID=<?php echo $app_id ?>">View Data</a>
                                        <a class="btn btn-xs btn-warning" href="Recepupdate.php?GetID=<?php echo $app_id ?>">Update</a>
                                      </td>
                                  </tr> 
                                      <?php 
                                           }  
