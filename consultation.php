			      ...
			      <div class="card card-body mx-3 mx-md-4 mt-n6">
			        <div class="row gx-4 mb-2">
			          ...
			          <div class="col-auto my-auto">
			            <div class="h-100">
			            		<form action="adminconsul_back.php" method="post">
								  ...
								  <div class="row mb-4">
								    <div class="col">
								      <div class="form-outline">
								        <input type="text" id="accin" name="p_name" class="form-control" />
								        <label class="form-label" for="form6Example1">Pet name</label>
								      </div>
								    </div>
								    <div class="col">
								      <div class="form-outline">
								        <input type="text" id="accin" name="l_name" class="form-control" />
								  ...
								  <div class="form-outline mb-4">
								    <textarea class="form-control" name="examination" id="accin" rows="3"></textarea>
								    <label class="form-label" for="form6Example3">Examination</label>
								  </div>

								  <!-- Text input -->
								  <div class="form-outline mb-4">
								    <textarea class="form-control"  name="test" id="accin" rows="3"></textarea>
								    <label class="form-label" for="form6Example4">Test</label>
								  </div>

								  <!-- Email input -->
								  <div class="form-outline mb-4">
								    <textarea class="form-control" name="d_diagnosis" id="accin" rows="3"></textarea>
								    <label class="form-label" for="form6Example5">Differential Diagnosis</label>
								  </div>

								  <!-- Number input -->
								  <div class="form-outline mb-4">
								    <textarea class="form-control" name="c_diagnosis" id="accin" rows="3"></textarea>
								    <label class="form-label" for="form6Example6">Consult Diagnosis</label>
								  </div>

								  <!-- Message input -->
								  <div class="form-outline mb-4">
								    <textarea class="form-control"  name="treatment" id="accin" rows="4"></textarea>
